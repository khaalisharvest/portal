      ...
      <div className="container-custom">
                ...
                {user ? (
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <svg className={`h-4 w-4 lg:h-5 lg:w-5 text-gray-600 group-hover:text-orange-600 transition-all duration-200 ${isMenuOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {isLoading ? (
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg className={`h-4 w-4 text-gray-600 group-hover:text-orange-600 transition-all duration-200 ${isMenuOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-4 pt-4 pb-6 space-y-2 border-t-2 border-primary-100 bg-gradient-to-b from-white to-primary-50 max-h-[80vh] overflow-y-auto">
              {/* Close Button */}
              ...
              <div className="space-y-1">
                <Link
                  href="/"
                  className="flex items-center space-x-3 px-4 py-3 text-base font-medium text-neutral-700 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all duration-200"
                  onClick={() => setIsMenuOpen(false)}
                >
                ...
                <button
                  ...
                  className="flex items-center space-x-3 px-4 py-3 text-base font-medium text-neutral-700 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all duration-200 w-full text-left"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="pt-4 border-t-2 border-primary-200">
                  <div className="space-y-1">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-3 px-4 py-3 text-base font-medium text-error-600 hover:bg-error-50 rounded-xl transition-all duration-200 w-full text-left"
                    >
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
